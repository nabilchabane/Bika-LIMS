...
schema = BikaSchema.copy() + Schema((
    ...
    ReferenceField('SampleCategory',
        ...
        relationship = 'ARTemplateSampleCategory',
        referenceClass = HoldingReference,
        accessor = 'getSampleCategory',
        edit_accessor = 'getSampleCategory',
        mutator = 'setSampleCategory',
        widget=ReferenceWidget(
    ...
    ComputedField(
        "SampleCategoryUID",
        expression="context.Schema()['SampleCategory'].get(context) and context.Schema()['SampleCategory'].get(context).UID() or ''",
        widget=ComputedWidget(
            visible=False,
        ),
    ),
