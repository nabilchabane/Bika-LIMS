...
schema = BikaSchema.copy() + Schema((
    ...
    ReferenceField('SampleCategory',
        ...
        relationship='SampleSampleCategory',
        referenceClass=HoldingReference,
        mode="rw",
        read_permission=permissions.View,
        write_permission=permissions.ModifyPortalContent,
    ...
    ComputedField('SampleCategoryTitle',
        searchable=True,
        expression="here.getSampleCategory() and here.getSampleCategory().Title() or ''",
        widget=ComputedWidget(
            label=_('Sample Category Title'),
            visible=True,
        ),
    ),
