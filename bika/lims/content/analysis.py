...
schema = BikaSchema.copy() + Schema((
    ...
    ComputedField('SampleCategoryUID',
        expression = 'context.aq_parent.getSample().getSampleCategory().UID() if context.aq_parent.getSample().getSampleCategory() else None',
    ),
